...
def delete_cafe(cafe_id):
    ...
    if api_key == "TopSecretAPIKey":
        ...
        if cafe:
            ...
            db.session.commit()
            return jsonify(response={"success": "Successfully delete the cafe from the databse."})
        else:
            return jsonify(error={"Not Found": "Sorry a cafe with id was not found in the database."})
    else:
